...
const LocaleTranslationData = {
	"en": {
		...
		"conversion.slope.intercept.zero": "Both the slope and the intercept are zero. Are you sure?",
	...
	"fr": {
		...
		"conversion.slope.intercept.zero": "Slope and Intercept are both zero. Are you sure?\u{26A1}",
