...
const LocaleTranslationData = {
	"en": {
		...
		"as.group.defaultgraphicunit": "as group default graphic unit",
		"as.meter.unit": "as meter unit",
		"unit.delete.restricted": "Deletion is not allowed due to the above restrictions.",
		"ascending": "Ascending",
		"bar": "Bar",
		...
		"conversion.bidirectional.disabled.suffix": "Selecting suffix units as sources or destinations will set bidirectional to no",
		...
		"conversion.default.graphic.unit": "Default Graphic Unit",
		"conversion.delete.success": "Successfully deleted conversion.",
		"conversion.delete.failure": "Failed to delete conversion.",
		"conversion.delete.conversion": "Delete Conversion",
		"conversion.delete.meter.orphan": "Deleting this conversion will orphan (make ungraphable) meter unit",
		"conversion.delete.group.orphan": "Deleting this conversion will orphan (make ungraphable) group",
		"conversion.delete.lost.units": "will lose access to these units after deletion",
		"conversion.delete.meter.affected": "The following meters will be affected by this deletion",
		"conversion.delete.group.affected": "The following groups will be affected by this deletion",		
		...
		"conversion.delete.meter.default.lost": "Meter default graphic unit lost",
		"conversion.delete.group.default.lost": "Group default graphic unit lost",
		...
		"conversion.slope.intercept.zero": "Both the slope and the intercept are zero. Are you sure you want to save this conversion?",
		...
		"csv.file": "CSV File:",
		"csv.file.error": "File must be in CSV format or GZIP format (.csv or .gz). ",
		"csv.readings.param.create.meter": "Create Meter",
		"csv.readings.param.honor.dst": "Honor Daylight Savings Time",
		"csv.readings.param.meter.identifier": "Meter Identifier:",
		...
		"csv.readings.param.use.meter.zone": "Use Meter Zone",
		"csv.readings.param.warn.on.cumulative.reset": "Warn if cumulative reset",
		...
		"csv.upload.meters": "Upload Meters",
		...
		"default.help.url": "Documentation URL",
		...
		"delete.self": "Cannot delete your own Account.",
		...
		"DisableChecksType.reject_disabled": "Yes, do not check values",
		"DisableChecksType.reject_none": "No, reject no readings but do check",
		...
		"error.displayable.suffix.input": "Suffix input will set displayable to none.",
		...
		"help.admin.header": "This page is to allow site administrators to set values.  Please visit {link} for further details and information.",
		...
		"help.admin.users": "This page allows admins to view and edit users. Please visit {link} for further details and information.",
		"help.csv.meters": "This page allows admins to upload meters via a CSV file. Please visit {link} for further details and information.",
		"help.csv.readings": "This page allows certain users to upload readings via a CSV file. Please visit {link} for further details and information.",
		...
		"help.home.bar.days.tip": "Allows user to select the desired number of days for each bar.  Please see {link} for further details and information.",
		...
		"help.home.compare.period.tip": "Selects the time interval (Day, Week or 4 Weeks) to compare for current to previous.  Please see {link} for further details and information.",
		...
		"help.home.select.datasources": "Select the data sources used in the graphic display. Note you can type in text to limit which groups and meters are shown. The \"Data Sources\" option in the top Please visit {link} for further details and information.",
		...
		"line": "Line",
		"log.in": "Log in",
		"log.limit.required": "Number of logs to display must be within 1 to 1000",
		...
		"meters": "Meters",
		"min": "min",
		"min.value": "Minimum Reading Value Check",
		"minute": "Minute",
		...
		"user.delete.confirm": "Delete the user: ",
		"user.password.edit": "Only enter password to update password",
		"user.password.length": "Password must be a minimum of 8 characters",
		"user.username.length": "Username must be a minimum of 3 characters",
		"user.password.mismatch": "Passwords do not match",
		"user.role": "Role: ",
		"user.role.select": "Select Role",
		"user.role.required": "Please select a role",
		"username": "Username:",
		"users": "Users",
		"users.failed.to.create.user": "Failed to create the user: ",
		"users.failed.to.delete.user": "Failed to delete the user: ",
		"users.failed.to.edit.user": "Failed to edit user: ",
		"users.successfully.create.user": "Successfully created the user: ",
		"users.successfully.delete.user": "Successfully deleted user: ",
		"users.successfully.edit.user": "Successfully edited user: ",
		"uses": "uses",
	...
	"fr": {
		...
		"as.group.defaultgraphicunit": "as group default graphic unit\u{26A1}",
		"as.meter.unit": "as meter unit\u{26A1}",
		"unit.delete.restricted": "Deletion is not allowed due to the above restrictions\u{26A1}.",
		"ascending": "Ascendant",
		"bar": "Bande",
		...
		"conversion.bidirectional.disabled.meter": "Selecting meter units as sources will set bidirectional to false\u{26A1}",
		"conversion.bidirectional.disabled.suffix": "Selecting suffix units as sources or destinations will set bidirectional to no\u{26A1}",
		...
		"conversion.default.graphic.unit": "Default Graphic Unit\u{26A1}",
		"conversion.delete.success": "Successfully deleted conversion.\u{26A1}",
		"conversion.delete.failure": "Failed to delete conversion.\u{26A1}",
		...
		"conversion.delete.group.orphan": "Deleting this conversion will orphan (make ungraphable) group\u{26A1}",
		"conversion.delete.lost.units": "Units this will lose access to after deletion\u{26A1}",
		"conversion.delete.meter.affected": "The following meters will be affected by this deletion\u{26A1}",
		"conversion.delete.group.affected": "The following groups will be affected by this deletion\u{26A1}",		
		"conversion.delete.meter.related": "The following meters use meter unit\u{26A1}",
		"conversion.delete.meter.default.lost": "Meter default graphic unit lost\u{26A1}",
		"conversion.delete.group.default.lost": "Group default graphic unit lost\u{26A1}",
		...
		"conversion.delete.simulation.error": "There was an error simulating the deletion of this conversion. Please try again later.\u{26A1}",
		...
		"csv.file.error": "Le fichier doit être au format CSV ou GZIP (.csv ou .gz). ",
		"csv.readings.param.create.meter": "Créer un compteur",
		"csv.readings.param.honor.dst": "Honor Daylight Savings Time\u{26A1}",
		"csv.readings.param.meter.identifier": "Identifiant du compteur:",
		"csv.readings.param.refresh.readings": "Actualiser les lectures",
		"csv.readings.param.relaxed.parsing": "Relaxed Parsing\u{26A1}",
		"csv.readings.param.time.sort": "Tri de l'heure:",
		"csv.readings.param.use.meter.zone": "Use Meter Zone\u{26A1}",
		"csv.readings.param.warn.on.cumulative.reset": "Warn if cumulative reset\u{26A1}",
		...
		"data.sources": "Data Sources\u{26A1}",
		...
		"default.help.url": "Documentation URL\u{26A1}",
		...
		"delete.self": "Impossible de supprimer votre propre compte.",
		"delete.user": "Supprimer l'utilisateur",
		"descending": "Descendant",
		"disable": "Désactiver",
		"disable.checks": "Disable Checks\u{26A1}",
		...
		"DisableChecksType.reject_disabled": "Yes, do not check values\u{26A1}",
		"DisableChecksType.reject_none": "No, reject no readings but do check\u{26A1}",
		...
		"edit.group": "Details/Modifier Groupe\u{26A1}",
		...
		"help.admin.header": "This page is to allow site administrators to set values.  Please visit {link} for further details and information.\u{26A1}",
		...
		"help.csv.meters": "Cette page permet aux administrateurs de téléverser des mètres via un fichier CSV. Veuillez visiter {link} pour plus de détails et d'informations.\u{26A1}",
		"help.csv.readings": "Cette page permet à certains utilisateurs de télécharger des lectures via un fichier CSV. Veuillez visiter {link} pour plus de détails et d'informations.\u{26A1}",
		...
		"help.home.compare.period.tip": "to compare for current to previous.  Please see {link} for further details and information.\u{26A1}",
		...
		"help.home.select.datasources": "Select the data sources used in the graphic display. Note you can type in text to limit which groups and meters are shown. The \"Data Sources\" option in the top Please visit {link} for further details and information.\u{26A1}",
		...
		"line": "Ligne",
		"log.in": "Se Connecter",
		"log.limit.required": "Number of logs to display must be within 1 to 1000\u{26A1}",
		...
		"maps": "Plans",
		"max": "max\u{26A1}",
		"max.value": "Maximum Reading Value Check\u{26A1}",
		"menu": "Menu",
		"meter": "Mèter",
		...
		"meter.settings": "Meter Settings\u{26A1}",
		...
		"meters": "Mèters",
		"min": "min\u{26A1}",
		"min.value": "Minimum Reading Value Check\u{26A1}",
		...
		"show.in.pages": "Show in Pages\u{26A1}",
		...
		"user.delete.confirm": "Supprimer l'utilisateur: ",
		"user.password.edit": "Only enter password to update password\u{26A1}",
		"user.password.length": "Le mot de passe doit comporter au moins 8 caractères",
		"user.username.length": "Le nom d'utilisateur doit comporter au moins 3 caractères",
		"user.password.mismatch": "Les mots de passe ne correspondent pas",
		"user.role": "Rôle: ",
		"user.role.select": "Sélectionnez rôle",
		"user.role.required": "Veuillez sélectionner un rôle",
		"username": "Nom d'utilisateur",
		"users": "Utilisateurs",
		"users.failed.to.create.user": "Échec de la création de l'utilisateur: ",
		"users.failed.to.delete.user": "Échec de la suppression de l'utilisateur: ",
		"users.failed.to.edit.user": "Échec de la modification de l'utilisateur: ",
	...
	"es": {
		...
		"area.error": "Por favor indique un número para el área",
		"area.normalize": "Normalizar según el área",
		...
		"as.group.defaultgraphicunit": "como unidad gráfica predeterminada del grupo",
		"as.meter.unit": "como unidad de medidor",
		"unit.delete.restricted": "La eliminación no está permitida debido a las restricciones anteriores.",
		...
		"BooleanMeterTypes.false": "no",
		"BooleanMeterTypes.meter": "medidor o valor predeterminado",
		"BooleanMeterTypes.true": "sí",
		"calibration.display": "Resultado:",
		"calibration.reset.button": "Restablecer",
		"calibration.save.database": "Guardar los cambios en la base de datos",
		"calibration.submit.button": "Enviar",
		"cancel": "Cancelar",
		"chart.link": "Enlace de la tabla",
		"child.groups": "Grupos secundarios",
		"child.meters": "Medidores secundarios",
		"clear.date.range": "Clear Date Range\u{26A1}",
		...
		"conversion.bidirectional.disabled.meter": "Seleccionar unidades de medidor como fuente establecerá bidireccional en falso",
		"conversion.bidirectional.disabled.suffix": "Seleccionar unidades de sufijo como fuente o destino establecerá bidireccional en no",
		...
		"conversion.create.exists.inverse": "Esta conversión ya existe en una que no es bidireccional",
		"conversion.create.mixed.represent": "Una conversión no puede mezclar unidades de cantidad, de flujo y crudas.",
		...
		"conversion.is.deleted": "Se borró la conversión en la base de datos",
		...
		"conversion.submit.new.conversion": "Ingresar una nueva conversión",
		...
		"csv": "CSV",
		"csv.clear.button": "Forma clara",
		"csv.common.param.gzip": "Gzip",
		"csv.common.param.header.row": "Fila de cabecera",
		"csv.common.param.update": "Actualización",
		"csv.download.size.limit": "Perdón, no tienes permiso para descargar por el número de puntos grande.",
		"csv.download.size.warning.size": "El tamaño todos los archivos juntos será de unos (usualmente dentro de 10% para exportaciones largas).",
		"csv.download.size.warning.verify": "Estás seguro que quieres descargar",
		"csv.file": "Archivo CSV:",
		"csv.file.error": "El archivo debe estar en formato CSV o GZIP (.csv o .gz). ",
		"csv.readings.param.create.meter": "Crear medidor",
		"csv.readings.param.honor.dst": "Seguir el horario de verano",
		"csv.readings.param.meter.identifier": "Identificador del medidor:",
		"csv.readings.param.refresh.readings": "Actualizar lecturas",
		...
		"default.bar.stacking": "Apilar barras por defecto",
		"default.file.size.limit": "Límite predeterminado de tamaño del archivo",
		"default.graph.settings": "Configuraciones predeterminadas del gráfico",
		"default.graph.type": "Tipo de gráfico por defecto",
		"default.help.url": "URL Documentación",
		"default.language": "Idioma predeterminado",
		"default.meter.disable.checks": "Desactivar revisiones de medidor predeterminado",
		"default.meter.maximum.date": "Revisión de la fecha de lectura máxima del medidor predeterminado",
		"default.meter.maximum.errors": "Número máximo de errores en la lectura del medidor",
		"default.meter.maximum.value": "Revisión del valor de lectura máxima del medidor predeterminado",
		"default.meter.minimum.date": "Revisión de la fecha de lectura mínima del medidor predeterminado",
		...
		"delete.self": "No puedes eliminar tu propia cuenta.",
		...
		"edit.group": "Details/Editar grupo\u{26A1}",
		"edit.meter": "Details/Editar medidor\u{26A1}",
		"edit.unit": "Details/Edit Unit\u{26A1}",
		"edit.user": "Editar Usuario",
		"edited": "editado",
		"enable": "Activar",
		"error.bar": "Mostrar las barras de errores",
		...
		"export.graph.data": "Exportar los datos del gráfico",
		"export.raw.graph.data": "Exportar los datos del medidor del gráfico",
		"failed.to.create.map": "No se pudo crear el mapa",
		"failed.to.delete.group": "No se pudo borrar el grupo",
		...
		"group.area.calculate": "Calcular el área del grupo",
		"group.area.calculate.error.group.unit": "No hay unidad de área del grupo",
		"group.area.calculate.error.header": "Los siguientes medidores fueron excluidos de la suma porque:",
		"group.area.calculate.error.no.meters": "No hay medidores en el grupo",
		"group.area.calculate.error.unit": ": el área es distinta a cero pero no tiene unidad",
		"group.area.calculate.error.zero": ": el área no está determinada o es cero",
		"group.area.calculate.header": "Área del grupo se establecerá en ",
		"group.create.nounit": "La unidad predeterminada del gráfico fue cambiado a sin unidad de ",
		"group.delete.group": "Borrar grupo",
		"group.delete.issue": "está en los siguientes grupos y no se puede borrar",
		"group.details": "Detalles del grupo",
		"group.edit.cancelled": "EL CAMBIO AL GRUPO ESTÁ CANCELADO",
		"group.edit.changed": "tendrá cambios en sus unidades compatibles por la edición al grupo",
		"group.edit.circular": "Añadir este medidor/grupo a este grupo crea una dependencia circular.",
		"group.edit.empty": "Quitar este medidor/grupo significa que no hay medidores o grupos secundarios, que no está permitido. Borra este grupo si quieres quitarlo.",
		"group.edit.nocompatible": "no tendría unidades compatibles por la edición a este grupo, por tanto se cancela la edición",
		"group.edit.nounit": "habrá cambios a sus unidades compatibles y su unidad de gráfico predeterminada puesto como \"sin unidad\" por la edición a este grupo",
		"group.edit.verify": "Dados estos mensajes, ¿quieres cancelar este cambio (selecciona Cancelar) o continuar (selecciona OK)?",
		"group.failed.to.create.group": "No se pudo crear un grupo con el mensaje: ",
		"group.failed.to.edit.group": "No se pudo editar el grupo con el mensaje: ",
		"group.gps.error": "Por favor indique un punto GPS valído: (latitud, longitud)",
		"group.hidden": "Hay por lo menos un grupo que no es visible para tí",
		"group.input.error": "Entrada no válida, por tanto no se creó o editó el grupo",
		"group.name.error": "Por favor indique un nombre válido: (debe tener por lo menos un carácter que no sea un espacio blanco)",
		...
		"help": "Ayuda",
		"help.admin.conversioncreate": "Esta página permite a los administradores crear conversiones. Por favor visite {link} para más detalles e información.",
		"help.admin.conversionedit": "Esta página permite a los administradores editar conversiones. Por favor visite {link} para más detalles e información",
		"help.admin.conversionview": "Esta página muestra información de conversiones. Por favor visite {link} para más detalles e información.",
		"help.admin.groupcreate": "Esta página permite a los administradores crear grupos. Por favor visite {link} para más detalles e información.",
		"help.admin.groupedit": "Esta página permite a los administradores editar grupos. Por favor visite {link} para más detalles e información.",
		...
		"help.admin.header": "Esta página permite a los administradores del sitio establecer valores.  Por favor, visite {link} para más detalles e información.",
		"help.admin.mapview": "Esta página permite a los administradores ver y editar mapas. Por favor, visite {link} para más detalles e información.",
		...
		"help.admin.users": "Esta página permite a los administradores ver y editar usarios. Por favor, visite {link} para más detalles e información.",
		"help.csv.meters": "Esta página permite a los administradores cargar medidores a través de un archivo CSV. Visite {enlace} para obtener más detalles e información.",
		"help.csv.readings": "Esta página permite a ciertos usuarios cargar lecturas a través de un archivo CSV. Visite {link} para obtener más detalles e información.",
		"help.groups.area.calculate": "Esto sumará el área de todos los medidores en este grupo que tengan un área distinta a cero y una unidad de área. Ignorará cualquier medidor que no tiene área o unidad de área. Si este grupo no tiene unidad de área, no hará nada.",
		...
		"help.groups.groupview": "Esta página muestra información sobre grupos. Por favor, visite {link} para más detalles e información.",
		"help.home.area.normalize": "Alterna la normalización por área. Medidores/Grupos sin área quedarán escondidos. Por favor visite {link} para obtener más detalles e información.",
		"help.home.bar.days.tip": "Permite al usuario seleccionar el número de días deseado para cada barra.  Por favor, visite {link} para más detalles e información.",
		"help.home.bar.interval.tip": "Selecciona el intervalo de tiempo (día, semana o 4 semanas) para cada barra.  Por favor, visite {link} para más detalles e información.",
		"help.home.bar.stacking.tip": "Apila las barras una encima de la otra. Por favor, visite {link} para obtener más detalles e información.",
		...
		"help.home.select.datasources": "Select the data sources used in the graphic display. Note you can type in text to limit which groups and meters are shown. The \"Data Sources\" option in the top Please visit {link} for further details and information.\u{26A1}",
		"help.home.select.dateRange": "Seleccione el rango de datos usado en el gráfico mostrado. Para gráficos 3D debe ser un año o menos. Por favor visite {link} para obtener más detalles e información.",
		"help.home.select.groups": "Los grupos se agregan (suman el uso) de cualquier combinación de grupos y medidores. Puede elegir cuales grupos quiere ver en el gráfico en el menú desplegable \"Grupos:\" . Tenga en cuenta que puede escribir texto para limitar los grupos que se muestran. La opción \"Grupos\" en el menú desplegable \"Páginas\" en la parte superior derecha de la ventana le permite ver más detalles sobre cada grupo y, si es un administrador, editar los grupos. Por favor visite {link} para obtener más detalles e información.",
		"help.home.select.maps": "Los mapas son una representación espacial de un sitio. Puede elegir el mapa que desea ver en el menú desplegable \"Mapas:\". Tenga en cuenta que puede introducir texto para limitar los mapas que se muestran. Por favor, visite {link} para más detalles e información.",
		"help.home.select.rates": "Las tasas determinan la normalización de tiempo para un gráfico de línea. Por favor visite {link} para obtener más detalles e información.",
		...
		"help.home.toggle.chart.link": "Con el botón \"Alternar enlace de gráfico\" aparece un cuadro que da un URL para recrear el gráfico actual. El enlace recreará el gráfico en el futuro, especialmente para que otros lo vean. La persona que usa este URL estará en un OED completamente funcional para que pueda realizar cambios después de mostrar el gráfico original. Puede desalentar los cambios eligiendo la opción de esconder las opciones del menú para que no sean visible al usar el URL. Por favor visite {link} para obtener más detalles e información.",
		"help.meters.meterview": "Esta página muestra información sobre los medidores. Por favor visite {link} para obtener más detalles e información.",
		"here": "aquí",
		"hide": "Esconder",
		"hide.options": "Esconder las opciones",
		"hide.options.in.link": "Esconder las opciones en el enlace",
		"home": "Inicio",
		"hour": "Hora",
		...
		"input.gps.coords.first": "Indique las coordenada de GPS que corresponden al punto: ",
		...
		"login.success": "Éxito al iniciar sesión",
		"logo": "Logo",
		"manage": "Gestionar",
		"map": "Mapa",
		...
		"map.bad.name": "Se necesita un nombre para el mapa",
		"map.bad.number": "No es número, por favor cambiar el angúlo a un número entre 0 a 360",
		...
		"maps": "Mapas",
		"max": "máximo",
		"max.value": "Revisión del valor máximo de lectura",
		"menu": "Menú",
		"meter": "Medidor",
		"meter.create": "Crear un medidor",
		"meter.cumulative": "Cumulativo",
		...
		"meter.input.error": "Entrada no válida, por tanto no se creó o editó el medidor.",
		"meter.is.displayable": "El medidor es visualizable",
		"meter.is.enabled": "Actualizaciones activadas",
		"meter.is.not.displayable": "El medidor no es visualizable",
		"meter.is.not.enabled": "El medidor no está activado",
		...
		"meter.previousEnd": "Marca de tiempo del final anterior:",
		...
		"meter.successfully.edited.meter": "Éxito al editar el medidor.",
		"meter.time.zone": "Zona horaria:",
		"meter.timeSort": "Ordenar por tiempo:",
		"meter.type": "Tipo:",
		"meter.unit.change.requires": "necesita cambiarse antes de cambiar el tipo de esta unidad",
		"meter.unit.is.not.editable": "La unidad de este medidor no puede cambiarse y se mantuvo el valor original porque: ",
		"meter.unitName": "Unidad:",
		"meter.url": "URL:",
		"meters": "Medidores",
		"min": "mínimo",
		"min.value": "Revisión del valor mínimo de lectura",
		"minute": "Minuto",
		"more.energy": "más energía",
		"more.options": "More Options\u{26A1}",
		"name": "Nombre:",
		"navigation": "Navegación",
		"need.more.points": "Nececita más puntos",
		"no": "no",
		"no.data.in.range": "No hay datos para el rango de fechas",
		"no.logs": "No logs to display. Please select another log type or data range\u{26A1}",
		"note": "Nota: ",
		"num.logs.display": "Number of logs to display\u{26A1}",
		"oed": "Panel de Energía Abierto",
		...
		"save.map.edits": "Guardar las ediciones al mapa",
		"save.meter.edits": "Guardar las ediciones al medidor",
		...
		"sort": "Sort Order\u{26A1}",
		"submit": "Enviar",
		"submit.changes": "Ingresar los cambios",
		"submit.new.user": "Ingresar un nuevo usario",
		"submitting": "Enviando",
		"the.unit.of.meter": "La unidad del medidor",
		"this.four.weeks": "Estas cuatro semanas",
		"this.week": "Esta semana",
		"threeD.area.incompatible": "<br>es incompatible<br> con normalización del área",
		"threeD.date": "Fecha",
		...
		"unit": "Unidad",
		"unit.delete.failure": "No se pudo borrar la unidad con error: ",
		"unit.delete.success": "Éxito al borrar la unidad",
		"unit.delete.unit": "Borrar la unidad",
		"unit.destination.error": "como la unidad de la destinación",
		"unit.dropdown.displayable.option.admin": "administrador",
		"unit.dropdown.displayable.option.all": "Todo",
		"unit.dropdown.displayable.option.none": "Ninguna",
		"unit.failed.to.create.unit": "No se pudo crear la unidad",
		"unit.failed.to.delete.unit": "No se puede borrar por que esta unidad está siendo usada por lo siguiente",
		"unit.failed.to.edit.unit": "No se pudo editar la unidad",
		"unit.input.error": "Entrada no válida, por tanto no se creó ni se editó la unidad.",
		...
		"update": "actualizar",
		"updated.map.with.calibration": "Mapa actualizado con una calibración nueva",
		"updated.map.without.calibration": "Mapa actualizado sin calibrar",
		"updated.map.without.new.calibration": "Mapa actualizado",
		"updated.preferences": "Preferencias actualizadas",
		"upload.meters.csv": "Subir archivo CSV de medidores",
		"upload.new.map.with.calibration": "Se subió un mapa calibrado nuevo",
		"upload.new.map.without.calibration": "Se subió un mapa sin calibrar nuevo",
		"upload.readings.csv": "Subir archivo CSV de lecturas",
		"used.so.far": "usado hasta ahora",
		"used.this.time": "usado esta vez",
		"user.delete.confirm": "Borrar usuario: ",
		"user.password.edit": "Únicamente ingrese la contraseña si la quiere actualizar",
		"user.password.length": "La contraseña debe tener un mínimo de 8 caracteres",
		"user.username.length": "El nombre de usuario debe tener un mínimo de 3 caracteres",
		"user.password.mismatch": "Las contraseñas no coinciden.",
		"user.role": "Rol: ",
		"user.role.select": "Seleccionar rol",
		"user.role.required": "Por favor seleccione un rol",
		"username": "Nombre de usuario:",
		"users": "Usuarios",
		"users.failed.to.create.user": "No se pudo crear usuario: ",
		"users.failed.to.delete.user": "No se pudo eliminar usuario: ",
		"users.failed.to.edit.user": "No se pudo editar usuario: ",
		"users.successfully.create.user": "Usuario creado con éxito: ",
		"users.successfully.delete.user": "Usuario borrado con éxito: ",
		"users.successfully.edit.user": "Usuario editados con éxito: ",
		"uses": "uses\u{26A1}",
