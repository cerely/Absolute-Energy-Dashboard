...
const LocaleTranslationData = {
	...
	"es": {
		...
		"help.home.select.meters": "Los medidores son la unidad básica de uso y generalmente representan las lecturas de un solo medidor de uso. Puede elegir cuales medidores quiere ver en el gráfico desde el menú desplegable \"Medidores:\". Tenga en cuenta que puede escribir texto para limitar los medidores que se muestran. La opción \"Medidores\" en el menú desplegable \"Páginas\" en la parte superior derecha de la ventana le permite ver más detalles sobre cada medidor y, si es un administrador, editar los medidores . Por favor visite {link} para obtener más detalles e información.",
